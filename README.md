...
2) Это уже предобученная модель [MSG-Net](https://github.com/zhanghang1989/PyTorch-Multi-Style-Transfer) от [zhanghang1989](https://github.com/zhanghang1989). Результат этой модели получается очень быстро, так как модель не особо большая и уже присутствуют предобученные веса, но качество получаемых изображений меня не совсем устраивает, хотя, может, кому-то и понравится. Примеры снизу:
